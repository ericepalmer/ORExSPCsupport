c  Version 1.0 - 2 Nov 2023
c	Hopefully this will read images for a lat/lon and
c      display the coordiantes for a polar plto
C  Right now, it just converts x, y, z into lat/lon
