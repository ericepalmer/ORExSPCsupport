...
def remEdge(image):
    ...
    if cnt > 0:
        ...
        if len(outside) == 1:
            ...
            elif not box[idim[0]+cnt][idim[1]+cnt]:
                a = cnt-1
                b = cnt-1
                newCorner = box[a][b]
