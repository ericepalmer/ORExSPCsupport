...
if len(opt) == 1:
    ...
    im1,im2 = raw_input('Please enter the filenames now: \n').split()
...
def readMAP(file):
    ...
    for i in range(0,len(mapData),3):
        heights.append(hscale*unpack('>h', mapData[i:i+2])[0])
...
if out == 'true':
    ...
    ax3.plot(x,y,'rs',ms=6,fillstyle='none')       # Box around correlation peak
