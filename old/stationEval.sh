...
echo "#Name 	  RES		Lat        wLon	           FB0        FB1        FB2        FB3       FB4      FB5a       FB5b       FB6a       FB6b      FB7      PStations rA" > eval/evalStation.txt 
...
do
 ...
 echo "$info $FB0 $FB1 $FB2 $FB3       $FB4 $FB5a $FB5b $FB6a $FB6b       $FB7        $Stat  $recA" >> eval/evalStation.txt
