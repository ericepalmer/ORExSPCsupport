c  Version 1.0 - 11 December 2015 - John Weirich (from Eric Palmer (from Gaskell))
c This will move a maplet or bigmap from one location to another on the object
c
c All maplet names are hard coded below under "LMRKFILE = XXX"
c The first READ_MAP is the map that is at the location you want the maplet moved to
c , the second READ_MAP is the map you want moved, and the WRITE_MAP is the output map.
c
c  gfortran moveMap.f -O2 -o ~/bin/moveMap.e
      ...
      DOUBLE PRECISION      V_SAVE(3)
      DOUBLE PRECISION      UX_SAVE(3)
      DOUBLE PRECISION      UY_SAVE(3)
      DOUBLE PRECISION      UZ_SAVE(3)
